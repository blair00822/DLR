...
from train import DualSubspaceHead, classifier, get_model, arg_parse
...
if __name__ == "__main__":
    ...
    # ==== test files (different manipulation methods)====
    specs = {
    ...
    with torch.no_grad():
        ...
        for name, loader in fake_loaders.items():
            ...
            if s_fake.size:
                ...
                # EER threshold for FAR / FRR / HTER
                far = float(np.mean(s_fake < t_eer))     
